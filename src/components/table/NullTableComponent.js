    ...
    return (
        <div>
            <div className='w-full lg:w-half xl:w-half m-auto flex flex-col items-center justify-center gap-4 py-20'>
                ...
                <h2 className='text-lg font-bold font-cabinetgrotesk'>{title || 'Unable to fetch data'}</h2>
                <p className="text-lighterAsh text-xs text-center max-w-30">{details || 'We are unable to fetch this data. Please check your connection or contact administrator'}</p>
            </div>
