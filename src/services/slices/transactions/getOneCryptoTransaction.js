...
export const queryOneCryptoTransactions = createAsyncThunk(
    'getCryptoFiatTransactions/queryOneCryptoTransactions',
    async ({ id }) => {
        try {
...
export const oneCryptoTransactionSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(
                queryOneCryptoTransactions.rejected,
                (state, { payload }) => {
                    return (state = {
                        ...state,
                        loading: false,
...
// A selector
export const getOneCryptoTransactionsSelector = (state) =>
    state.oneCryptoTransaction
