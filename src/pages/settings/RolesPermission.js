                        ...
                        <div key={index}>
                            <Col xs={12} sm={12} md={6} lg={5} xl={4}>
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-medium text-mainColor">
                                            {items.role}
                                        </h3>
                ...
                <div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-6 pt-16 pb-8 px-6">
                        ...
                        <p className="text-lighterAsh text-lg text-center">
                            Users you have invited will get a link in their
                            email address to sign in and activate their account
                            on XPAD.
                        </p>
                        <CustomButton
                            text={'Dismiss'}
