...
`;
  const items = [
    {
      key: '1',
      label: <p className='text-mainColor font-bold font-cabinetgrotesk text-xl'>Quidax</p>,
      children: <QuidaxContent />,
    },
    {
      key: '2',
      label: <p className='text-mainColor font-bold font-cabinetgrotesk text-xl'>Fire Blocks</p>,
      children: <p>{text}</p>,
    },
    {
      key: '3',
      label: <p className='text-mainColor font-bold font-cabinetgrotesk text-xl'>Binance</p>,
      children: <p>{text}</p>,
    },
    {
      key: '4',
      label: <p className='text-mainColor font-bold font-cabinetgrotesk text-xl'>Baxi</p>,
      children: <p>{text}</p>,
    },
    {
      key: '3',
