        ...
        <div className="border border-ash-2 rounded-md p-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h3 className="text-xs ms:text-sm lg:text-sm xl-text-sm font-bold text-mainColor">
                        {value}
                    </h3>
                </div>
            </div>
                    ...
                    <Col xs={4} sm={4} md={4} lg={4} xl={3}>
                        <div className="w-8 md:w-20 lg:w-20 xl:w-20 h-8  md:h-20 lg:h-20 xl:h-20 rounded-full flex items-center justify-center bg-ash-01">
                            <img
                                ...
                                className="object-contain w-8 md:w-14 lg:w-14 xl:w-14 h-8  md:h-14 lg:h-14 xl:h-14 rounded-large"
                            />
                        </div>
                    </Col>
