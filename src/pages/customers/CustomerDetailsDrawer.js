...
const CustomerDetailsDrawer = ({ title, date }) => {
    return (
        <div>
            <div className="p-5">
                <h2 className="text-xl font-bold font-cabinetgrotesk text-mainColor break-words max-w-1/2">
                    {title}
                </h2>
                <p className="text-sm font-medium text-lighterAsh">
                    Date Uploaded &nbsp;{' '}
                    <span className="text-mainColor">{date}</span>
                </p>
            </div>
